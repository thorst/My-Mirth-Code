/**
    ...
    according to the specified format. You HAVE to pass the format.
    
    More info on DateTimeFormatter:
    ...
    @param {String} myDateString - The date string 
    @param {String} format - The format, using the above symbols
    @return {java.time.LocalDateTime} return a java localdatetime object
	
    Example:
        var d = dtParse("20220322074705","yyyyMMddHHmmss");
        echo(d.toString());
*/
function dtParse(myDateString, format) {
