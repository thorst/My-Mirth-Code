/**
    ...
    https://github.com/nextgenhealthcare/connect-examples/blob/master/Code%20Templates/Filter%20XMLLists/xFilter.js
*/
function e4xFilter(xmlList, callback, minLimit, maxReturned, enforceMax) {
    var ret = new XMLList();
